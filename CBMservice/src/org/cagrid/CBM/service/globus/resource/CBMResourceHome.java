 ...
 * 
 */
public class CBMResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(CBMResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		CBMResource resource = (CBMResource) super.find(key);
		return resource;
	}
