...
import org.cagrid.CBM.stubs.CBMPortType;
import org.cagrid.CBM.stubs.service.CBMServiceAddressingLocator;
 ...
 */
public abstract class CBMClientBase extends ServiceSecurityClient {	
	protected CBMPortType portType;
	...
	public CBMClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public CBMClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
