 ...
 * 
 */
public class CBMAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://CBM.cagrid.org/CBM";
	
	Map authorizationClassMap = new HashMap();
	
	
	public CBMAuthorization() {
	}
	...
	public void authorizeExtractCBMdata(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
