...
import org.cagrid.CBM.common.CBMConstants;
import org.cagrid.CBM.stubs.CBMResourceProperties;
 ...
 * 
 */
public abstract class CBMResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(CBMResourceBase.class);

	private CBMResourceConfiguration configuration;
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((CBMResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CBMConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CBMResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CBMConstants.SERVICEMETADATA);
	...
	public org.cagrid.dataservice.cql.support.QueryLanguageSupport getQueryLanguageSupport(){
		return ((CBMResourceProperties) getResourceBean()).getQueryLanguageSupport();
	}
	...
	public void setQueryLanguageSupport(org.cagrid.dataservice.cql.support.QueryLanguageSupport queryLanguageSupport ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CBMConstants.QUERYLANGUAGESUPPORT);
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((CBMResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CBMResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
